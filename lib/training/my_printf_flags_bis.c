...
void d_o(UNUSED const char *str, va_list ap)
{
...
void d_none(UNUSED const char *str, UNUSED va_list ap)
{
	my_putchar('%');
}

void d_u(UNUSED const char *str, va_list ap)
{
...
void d_adr(UNUSED const char *str, va_list ap)
{
